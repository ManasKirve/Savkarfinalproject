          ...
          <div className="card stat-card border-danger">
            <div className="card-body text-center">
              <h3 className="text-danger">
                ₹{notices.reduce((sum, n) => sum + (n.amountDue || 0), 0).toLocaleString("en-IN")}
              </h3>
                  ...
                  filteredNotices.map((notice) => (
                    <tr key={notice.id}>
                      ...
                      <td className="text-danger fw-bold">
                        ₹{notice.amountDue.toLocaleString("en-IN")}
                      </td>
                      <td>
                        {new Date(notice.noticeDate).toLocaleDateString("en-GB")}                      </td>
                      <td>
                        <span
