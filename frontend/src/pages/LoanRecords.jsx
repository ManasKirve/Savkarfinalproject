...
const LoanRecords = () => {
  ...
  return (
    <div className="container-fluid pb-4 px-4">
      ...
      <div className="d-flex flex-column flex-md-row justify-content-end align-items-md-center mb-3 gap-2">
                ...
                {currentLoans && currentLoans.length > 0 ? (
                  currentLoans.map((loan) => (
                    <tr key={loan.id}>
                      ...
                      <td>₹{loan.totalLoan?.toLocaleString("en-IN")}</td>
                      <td>₹{loan.paidAmount?.toLocaleString("en-IN")}</td>
